...
namespace code
{
	...
	public partial class Application : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Angel_ID;
    ...
    partial void OnAngel_IDChanging(System.Nullable<int> value);
    partial void OnAngel_IDChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Angel_ID", DbType="Int")]
		public System.Nullable<int> Angel_ID
		{
			get
			{
				return this._Angel_ID;
			}
			set
			{
				if ((this._Angel_ID != value))
				{
					this.OnAngel_IDChanging(value);
					this.SendPropertyChanging();
					this._Angel_ID = value;
					this.SendPropertyChanged("Angel_ID");
					this.OnAngel_IDChanged();
				}
			}
		}
