...
namespace code
{
    ...
    partial void InsertAgelsAcceptedStartups(AgelsAcceptedStartups instance);
    partial void UpdateAgelsAcceptedStartups(AgelsAcceptedStartups instance);
    partial void DeleteAgelsAcceptedStartups(AgelsAcceptedStartups instance);
    #endregion
		...
		public System.Data.Linq.Table<CompanyMember> CompanyMember
		{
			get
			{
		...
		public System.Data.Linq.Table<AgelsAcceptedStartups> AgelsAcceptedStartups
		{
			get
			{
				return this.GetTable<AgelsAcceptedStartups>();
			}
		}
	}
	...
	public partial class AngelInvestor : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<AgelsAcceptedStartups> _AgelsAcceptedStartups;
    ...
    partial void OnTwitterChanged();
		...
		public AngelInvestor()
		{
			...
			this._AgelsAcceptedStartups = new EntitySet<AgelsAcceptedStartups>(new Action<AgelsAcceptedStartups>(this.attach_AgelsAcceptedStartups), new Action<AgelsAcceptedStartups>(this.detach_AgelsAcceptedStartups));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AngelInvestor_AgelsAcceptedStartups", Storage="_AgelsAcceptedStartups", ThisKey="ID", OtherKey="AppAngelID")]
		public EntitySet<AgelsAcceptedStartups> AgelsAcceptedStartups
		{
			get
			{
				return this._AgelsAcceptedStartups;
			}
			set
			{
				this._AgelsAcceptedStartups.Assign(value);
			}
		}
		...
		private void attach_AgelsAcceptedStartups(AgelsAcceptedStartups entity)
		{
			this.SendPropertyChanging();
			entity.AngelInvestor = this;
		}
		
		private void detach_AgelsAcceptedStartups(AgelsAcceptedStartups entity)
		{
			this.SendPropertyChanging();
			entity.AngelInvestor = null;
		}
	...
	public partial class Investment_Company : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CompanyMember> _CompanyMember;
    ...
    partial void OnCEOChanged();
		...
		public Investment_Company()
		{
			...
			this._Round_Investors = new EntitySet<Round_Investor>(new Action<Round_Investor>(this.attach_Round_Investors), new Action<Round_Investor>(this.detach_Round_Investors));
			this._CompanyMember = new EntitySet<CompanyMember>(new Action<CompanyMember>(this.attach_CompanyMember), new Action<CompanyMember>(this.detach_CompanyMember));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Investment_Company_CompanyMember", Storage="_CompanyMember", ThisKey="ID", OtherKey="CompID")]
		public EntitySet<CompanyMember> CompanyMember
		{
			get
			{
			...
			set
			{
				this._CompanyMember.Assign(value);
			}
		}
		...
		private void attach_CompanyMember(CompanyMember entity)
		{
			this.SendPropertyChanging();
			entity.Investment_Company = this;
		}
		
		private void detach_CompanyMember(CompanyMember entity)
		{
			this.SendPropertyChanging();
			entity.Investment_Company = null;
		}
	...
	public partial class Round_Of_Funding : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.DateTime> _invest_date;
    ...
    partial void OnDescriptionChanging(string value);
    partial void OnDescriptionChanged();
    partial void Oninvest_dateChanging(System.Nullable<System.DateTime> value);
    partial void Oninvest_dateChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_invest_date", DbType="datetime")]
		public System.Nullable<System.DateTime> invest_date
		{
			get
			{
				return this._invest_date;
			}
			set
			{
				if ((this._invest_date != value))
				{
					this.Oninvest_dateChanging(value);
					this.SendPropertyChanging();
					this._invest_date = value;
					this.SendPropertyChanged("invest_date");
					this.Oninvest_dateChanged();
				}
			}
		}
    ...
    partial void OnDevStageIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Startup_AgelsAcceptedStartups", Storage="_AgelsAcceptedStartups", ThisKey="ID", OtherKey="AppStartupID")]
		public EntitySet<AgelsAcceptedStartups> AgelsAcceptedStartups
		{
			get
			{
    ...
    partial void OnLoggedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_CompanyMember", Storage="_CompanyMember", ThisKey="ID", OtherKey="UserID")]
		public EntitySet<CompanyMember> CompanyMember
		{
			get
			{
    ...
    partial void OnTypeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Information", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
    ...
    partial void OnTwitterChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Investment_Company_CompanyMember", Storage="_Investment_Company", ThisKey="CompID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Investment_Company Investment_Company
		{
			get
			{
			...
			set
			{
							...
							|| (this._Investment_Company.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Investment_Company.Entity = null;
						previousValue.CompanyMember.Remove(this);
					}
					this._Investment_Company.Entity = value;
					if ((value != null))
					{
						value.CompanyMember.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_CompanyMember", Storage="_User", ThisKey="UserID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public User User
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AgelsAcceptedStartups")]
	public partial class AgelsAcceptedStartups : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _AppAngelID;
		
		private int _AppStartupID;
		
		private System.DateTime _AppAcceptDate;
    ...
    partial void OnIDChanging(int value);
    partial void OnIDChanged();
    partial void OnAppAngelIDChanging(int value);
    partial void OnAppAngelIDChanged();
    partial void OnAppStartupIDChanging(int value);
    partial void OnAppStartupIDChanged();
    partial void OnAppAcceptDateChanging(System.DateTime value);
    partial void OnAppAcceptDateChanged();
    #endregion
		
		public AgelsAcceptedStartups()
		{
			this._Startup = default(EntityRef<Startup>);
			this._AngelInvestor = default(EntityRef<AngelInvestor>);
			OnCreated();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AppAngelID", DbType="Int NOT NULL")]
		public int AppAngelID
		{
			get
			{
				return this._AppAngelID;
			}
			set
			{
				if ((this._AppAngelID != value))
				{
					if (this._AngelInvestor.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnAppAngelIDChanging(value);
					this.SendPropertyChanging();
					this._AppAngelID = value;
					this.SendPropertyChanged("AppAngelID");
					this.OnAppAngelIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AppStartupID", DbType="Int NOT NULL")]
		public int AppStartupID
		{
			get
			{
				return this._AppStartupID;
			}
			set
			{
				if ((this._AppStartupID != value))
				{
					if (this._Startup.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnAppStartupIDChanging(value);
					this.SendPropertyChanging();
					this._AppStartupID = value;
					this.SendPropertyChanged("AppStartupID");
					this.OnAppStartupIDChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AppAcceptDate", DbType="DateTime NOT NULL")]
		public System.DateTime AppAcceptDate
		{
			get
			{
				return this._AppAcceptDate;
			}
			set
			{
				if ((this._AppAcceptDate != value))
				{
					this.OnAppAcceptDateChanging(value);
					this.SendPropertyChanging();
					this._AppAcceptDate = value;
					this.SendPropertyChanged("AppAcceptDate");
					this.OnAppAcceptDateChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Startup_AgelsAcceptedStartups", Storage="_Startup", ThisKey="AppStartupID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Startup Startup
		{
			get
			{
			...
			set
			{
							...
							|| (this._Startup.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Startup.Entity = null;
						previousValue.AgelsAcceptedStartups.Remove(this);
					}
					this._Startup.Entity = value;
					if ((value != null))
					{
						value.AgelsAcceptedStartups.Add(this);
						this._AppStartupID = value.ID;
					}
					else
					{
						this._AppStartupID = default(int);
					}
					this.SendPropertyChanged("Startup");
				}
			}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="AngelInvestor_AgelsAcceptedStartups", Storage="_AngelInvestor", ThisKey="AppAngelID", OtherKey="ID", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public AngelInvestor AngelInvestor
		{
			get
			{
			...
			set
			{
							...
							|| (this._AngelInvestor.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.AgelsAcceptedStartups.Add(this);
						this._AppAngelID = value.ID;
					}
					else
					{
						this._AppAngelID = default(int);
					}
					this.SendPropertyChanged("AngelInvestor");
				}
			}
